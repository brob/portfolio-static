$(document).ready(function(){
    ...
    if ( $(window).width() > 767 ) {
		...
		// Set the initial opacity of work items to 0.5
		$('#section-works .item').fadeTo(0, 0.5);
		$('#section-intro li').fadeTo(0, 1);
		// $('#section-works .caption').fadeTo(0, 0);

		// Fade in and out on hover in/out
		$('#section-works .item').hover(function() {
			$(this).stop().fadeTo(200, 1);
			// $('#section-works .caption').stop().fadeTo(0, 1);
		}, function () {
			$(this).stop().fadeTo(200, 0.5);
			// $('#section-works .caption').stop().fadeTo(0, 0);
		});

		$('#section-intro li').hover(function() {
			$(this).stop().fadeTo(200, 0.5);
			// $('#section-works .caption').stop().fadeTo(0, 1);
		}, function () {
			$(this).stop().fadeTo(200, 1);
